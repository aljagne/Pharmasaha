...
export default function TenderLifecycle() {
  return (
    <section className="bg-[#00080A] py-32 lg:py-24 overflow-hidden">
      
      {/* ── DESKTOP HORIZONTAL SCROLL → CSS Snap Scroll ── */}
      <div className="hidden lg:block">
        ...
        <div className="overflow-x-auto pl-12 pb-12 scrollbar-hide">
          <div className="flex gap-12 w-max snap-x snap-mandatory pr-[20vw]">
            {LIFECYCLE_STEPS.map((step, idx) => (
              <div 
                key={idx} 
                className="w-[450px] flex-shrink-0 group relative cursor-crosshair snap-start"
              >
