  ...
  return (
    <section id="about" className="py-24 bg-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              {values.map((item) => {
                ...
                return (
                  <div key={item.title} className="flex space-x-4 group">
                    ...
                    <div>
                      <h3 className="text-[#001D21] font-semibold mb-2">{item.title}</h3>
          ...
          <div className="relative">
            ...
            <div className="relative rounded-2xl overflow-hidden shadow-xl">
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-t from-[#001D21]/60 via-transparent to-transparent" />
            </div>

            {/* Floating Stats Card */}
            <div className="absolute -bottom-8 -left-8 bg-white rounded-2xl p-6 border border-[#B8DFC2] shadow-xl">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <div className="text-2xl font-bold text-[#001D21]">100%</div>
            ...
            {/* Floating Team Card */}
            <div className="absolute -top-4 -right-4 bg-white rounded-2xl p-6 border border-[#B8DFC2] shadow-xl">
              <div className="flex items-center space-x-4">
                <div className="w-14 h-14 rounded-full bg-[#BBBAFF]/10 flex items-center justify-center">
                  <Users className="w-7 h-7 text-[#BBBAFF]" />
                </div>
                <div>
                  <div className="text-2xl font-bold text-[#001D21]">30+</div>
        ...
        {/* Stats Bar */}
        <div className="mt-20 grid grid-cols-2 md:grid-cols-4 gap-8 p-8 bg-[#CCEED3] rounded-2xl border border-[#B8DFC2]">
