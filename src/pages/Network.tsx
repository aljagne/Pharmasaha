  ...
  return (
    <PageTransition>
      <div className="flex flex-col min-h-screen bg-background text-foreground">
        ...
        {/* ─── NETWORK HERO ─── */}
        <section className="relative min-h-[70vh] flex items-center justify-center overflow-hidden border-b border-white/5 pt-32 pb-20">
          {/* Abstract Data Nodes Background */}
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[1000px] h-[1000px] bg-secondary/10 rounded-[40%] blur-[120px] pointer-events-none mix-blend-screen" />
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-6 text-center w-full">
            ...
            <h1 className="text-5xl md:text-7xl lg:text-[7.5rem] font-black text-white tracking-tighter leading-[0.9] flex flex-wrap justify-center gap-x-6 gap-y-2 mt-4">
              <div className="overflow-hidden pb-4"><span className="hero-reveal hero-reveal-2 inline-block text-white">Routing</span></div>
              <div className="overflow-hidden pb-4"><span className="hero-reveal hero-reveal-2 inline-block text-transparent bg-clip-text bg-gradient-to-r from-primary via-secondary to-white">Global</span></div>
              <div className="overflow-hidden pb-4 w-full flex justify-center"><span className="hero-reveal hero-reveal-3 inline-block text-white">Innovation.</span></div>
            </h1>
            
            <p className="hero-reveal hero-reveal-4 mt-12 text-white/50 text-lg md:text-xl max-w-3xl mx-auto leading-relaxed font-light">
